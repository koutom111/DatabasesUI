#3.3
SELECT  F.Scientific_Field, P.Project_Title, R.Last_Name, R.First_Name
FROM Field F
...
WHERE P.Starting_Date <= '2021-05-28' 
AND P.Due_Date >= '2022-05-28' 
AND F.Scientific_Field = 'Engineering';
