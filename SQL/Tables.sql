...
CREATE TABLE `Project` (
  ...
  `Program_Title` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Organization_Name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `Deliverable` (
  ...
  `Project_Title` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Summary` mediumtext COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Due_Date` date DEFAULT NULL,
